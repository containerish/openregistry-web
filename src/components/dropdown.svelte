...
<div class="w-56 text-right">
	<div class="relative inline-block text-left">
		<div>
			<Menu>
				<MenuButton
					class="inline-flex justify-center gap-2 w-full px-6 py-2 text-sm font-medium text-white bg-black rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
				>
					{user.username}
				...
				>
					...
					>
						<MenuItem let:active class="px-1 py-1">
							<button
						...
						<MenuItem disabled class="px-1 py-1">
...
<!-- 					> -->
<!-- 						<GithubOutline styles="w-8 h-8"/> -->
<!-- 						<span class="mx-1">Connect Git</span> -->
<!-- 					</a> -->
