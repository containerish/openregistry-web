...
<div class="relative inline-block ">
	...
	{#if show}
		<div
			class="absolute dark:bg-brown-800 right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-gray-100 rounded-md shadow-xl"
		>
			<a
				href="#"
				class="flex items-center p-3 -mt-2 text-sm text-gray-600 transitio-colors duration-200 transform dark:text-gray-300 hover:bg-white dark:hover:bg-brown-100 dark:hover:text-white hover:no-underline"
			>
				<img
				...
				<div class="mx-1">
					...
					<p class="text-sm text-gray-500 dark:text-gray-300">janedoe@example.com</p>
				</div>
			</a>
