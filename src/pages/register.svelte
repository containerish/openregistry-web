...
<form class="my-8 w-full">
	<div class="flex items-center">
		...
		<div class="flex flex-3">
			<button on:click={onClick} class="inline-flex tracking-wider ml-4 btn items-center px-4 py-2 font-normal leading-6 text-md shadow rounded-md text-gray-50 bg-gray-100 transition ease-in-out duration-150">
				{#if isLoading}
