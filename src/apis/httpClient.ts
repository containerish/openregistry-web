import {
    PUBLIC_OPEN_REGISTRY_APP_NAME,
    PUBLIC_OPEN_REGISTRY_ENVIRONMENT,
    PUBLIC_OPEN_REGISTRY_APP_VERSION,
    PUBLIC_OPEN_REGISTRY_SUPPORT_ENDPOINT,
...
abstract class HttpClient {
    ...
    private getUserAgent = () => {
        const agentName = `${PUBLIC_OPEN_REGISTRY_APP_NAME}/${PUBLIC_OPEN_REGISTRY_ENVIRONMENT} ${PUBLIC_OPEN_REGISTRY_APP_VERSION}`;
        return agentName;
    };
}
