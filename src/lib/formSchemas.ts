...
export const OpenRegistryUserType = z.enum(['user', 'organization', 'system']);
export const OpenRegistryUserSchema = z.object({
	...
	favorite_repositories: z.array(z.string()).nullish().default([]),
...
export const AuthTokenList = z.array(AuthToken).nullish().default([]);
