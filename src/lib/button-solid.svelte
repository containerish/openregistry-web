...
<button
	...
	desktop:h-11 laptop:h-11 rounded-md text-lg laptop:text-base desktop:text-base capitalize font-medium border-2 bg-primary-300 border-primary-700 text-primary-800 
