...
>
	...
	<div class="px-3 flex flex-col justify-between items-center text-sm gap-3 md:gap-6 max-w-[360px]">
		...
		<span class=" text-slate-600">
			The container image submitted by user is divided into one or more layers depending on a few factors like
			size.
		</span>
		<div class="rounded bg-primary-100/30 shadow-2xl shadow-primary-100 flex justify-center p-3 w-full mr-6">
			<LaboratoryIcon />
		</div>
	</div>
	...
	<div class="px-3 flex flex-col justify-between items-center text-sm gap-3 md:gap-6 max-w-[360px]">
		...
		<span class=" text-slate-600 px-1">
			The layers are further divided into blobs and sequentially uploaded to the storage backend of user's
			preference like IPFS or Storj.
		</span>
		<div class="rounded bg-primary-100/30 shadow-2xl shadow-primary-100 flex justify-center p-3 w-full mr-6">
			<LayersIcon />
		</div>
	...
	<div class="px-3 flex flex-col justify-between items-center text-sm gap-3 md:gap-6 max-w-[360px]">
		...
		<span class=" text-slate-600 px-1">
			A resolver component uploads the blobs to IPFS/Stoj and brings back the content hash which is mapped to the
			container image.
		</span>
		<div class="rounded bg-primary-100/30 shadow-2xl shadow-primary-100 flex justify-center p-3 w-full mr-6">
			<CloudIcon />
	...
	<div class="px-3 flex flex-col justify-between items-center text-sm gap-3 md:gap-6 max-w-[360px]">
		...
		<span class=" text-slate-600 px-1">
			Once all the blobs for a layer are recieved,a digest is calculated which is used with content hash while
			retrival of the layer.
		</span>
		<div class="rounded bg-primary-100/30 shadow-2xl shadow-primary-100 flex justify-center p-3 w-full mr-6">
			<ConfirmIcon />
		</div>
