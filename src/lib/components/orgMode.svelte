...
<div class="flex flex-col gap-3 h-full w-full">
	...
	{:else if user.user_type === "organization"}
		...
		<div
			class="flex w-full justify-center items-center h-full flex-col gap-2"
		>
			...
			{#if !orgUsers || orgUsers.length === 0}
				...
				>
					...
					>
						<div class="flex gap-2 items-center mb-3">
							<span
								class="text-primary-500 text-2xl font-semibold"
						...
						<p class=" max-w-lg text-slate-700 antialiased">
							...
							Please add some users and configure their
							permissions
						</p>
						<p class=" max-w-lg text-slate-600 antialiased">
							Please note that once you have converted into an
							Org, you cannot revert the change to become a user
							again
						</p>
						<ButtonSolid
							isLoading={isConvertOrgLoading}
						...
						<div class="flex flex-col gap-6">
							<div class="flex justify-between items-center">
								...
								>
									...
									<div
										class="flex flex-col justify-center items-start gap-3"
									>
										<span
											class="font-semibold antialiased text-slate-600"
										>
											Permissions
										</span>
										<div
