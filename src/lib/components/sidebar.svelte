...
<div class="bg-slate-50 desktop:min-h-max rounded-sm flex flex-col justify-center items-center gap-14">
	{#if compact == true}
		<div
			...
			shadow-2xl py-6 min-h-[1610px] desktop:min-h-max my-0.5"
		>
			<div>
				<picture>
			...
			<a href="https://github.com/containerish/OpenRegistry"
				><StarIcon styles="w-8 h-8 desktop:w-6 desktop:h-6 text-primary-400" /></a
			>
			...
			<div class="flex flex-col justify-center gap-10 desktop:gap-4">
				...
				<div class="flex flex-col gap-10 desktop:gap-4">
					...
					<div class="flex flex-col gap-3.5 desktop:gap-2">
                     ...
                     py-2.5 hover:bg-slate-100 hover:shadow-2xl hover:no-underline"
						>
							<StarIcon styles="w-6 h-6 desktop:w-5 desktop:h-5" />
							<span>Star us on Github</span>
						</a>
						<button
							on:click={toggleModal}
							class="bg-transparent border-0 flex flex-row gap-3 justify-start items-center text-slate-600 text-xl desktop:text-[16px] px-3
                     py-2.5 hover:bg-slate-100 hover:shadow-2xl hover:no-underline"
						>
