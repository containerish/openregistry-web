...
<Card id="top" styles="w-full flex flex-col px-0">
	<div class="flex w-4/5 flex-col items-center justify-center gap-4 md:w-full md:gap-8 xl:gap-24">
		<picture class="w-full">
			<source media="(min-width: 2000px)" srcset="./big-hero.svg" />
			<source media="(min-width: 650px)" srcset="./small-hero.svg" />
			<source media="(min-width: 465px)" srcset="./small-hero.svg" />
			<img alt="hero svg" class="w-full" src="./hero.svg" />
		</picture>

		<div class="w-4/6 text-primary-600">
			<div class="text-center">
				<span
					class="break-words text-3xl font-semibold 
				md:text-5xl xl:font-bold 2xl:text-6xl"
				>
			...
			<div class="w-full">
				<p
					class="mt-5 break-words text-center text-base text-primary-600 md:text-lg 
				...
				<p
					class="break-words text-center text-base text-primary-600 md:text-lg 
					apple:text-2xl uw:text-2xl"
				>
			...
			>
				<div>
					<input
						...
						class="form-control focus:ring-priamry-400 ease-in-outfocus:border-primary-500 m-0 block w-80 rounded-md border-2 bg-white 
						bg-clip-padding px-3 py-2 text-base font-normal text-gray-700 placeholder-gray-500 transition 
						focus:text-gray-700 focus:outline-none focus:ring focus:ring-opacity-40
						md:w-96 apple:py-4"
					/>
				</div>
	...
	<div
		class="grid w-1/2 grid-cols-2 place-items-center gap-2 py-10 px-4 md:w-3/5 md:min-w-[600px] md:grid-cols-3
		md:gap-8 md:py-0 md:pb-4 lg:py-20 xl:grid-cols-5 max-w-[1500px]"
	>
		<div class="col-span-2 pb-10 md:col-span-3 xl:col-span-5">
			<div
