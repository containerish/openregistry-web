...
<button
	...
	rounded-md bg-transparent h-[60px] desktop:h-11 capitalize text-lg font-medium hover:shadow-primary-100 hover:shadow-3xl desktop:text-sm 
	desktop:font-normal desktop:border-[1.5px] disabled:bg-slate-200 disabled:hover:rounded-md disabled:shadow-none"
>
	{#if isLoading}
