...
<div class="desktop:min-h-max laptop:min-h-max min-h-[1700px] w-full laptop:max-w-[1000px] half:min-h-max  flex flex-col mx-2 py-4">
	<div
	...
	>
		<div class="flex items-center">
			<Globe styles="h-16 w-16 desktop:h-11 desktop:w-11 laptop:h-11 laptop:w-11 half:w-11 half:h-11 text-slate-700" />
		</div>
		<div class="w-full text-slate-700">
			<div class="flex gap-4">
				<span class="text-[41px] laptop:text-3xl desktop:text-3xl half:text-2xl">{data.username}/{data.repo}</span>
				<button
	...
	<div class="w-full h-full py-4 flex px-4 laptop:px-1 justify-center">
		...
		{#if isOverview}
			<div class="flex laptop:flex-col half:flex-col justify-center items-center gap-10 w-full">
				<div
					class="min-w-max max-w-[1500px] w-2/3 min-h-[300px] laptop:min-h-[200px] half:min-h-[200px] bg-slate-50 border border-primary-50  mx-3 
					h-full rounded-sm px-8 py-8 flex justify-center items-center laptop:w-full half:w-full"
				>
					<span class="text-slate-500 text-3xl desktop:text-2xl laptop:text-2xl half:text-xl">No Overview Available</span>
				</div>
				<div
					class="min-w-max max-w-[500px] min-h-[280px] laptop:min-h-[250px] laptop:gap-2 half:min-h-[230px] half:gap-2 flex flex-col justify-center items-center gap-5 bg-slate-50 border
						border-primary-50 w-4/12 rounded-sm mx-4 px-4 laptop:mx-1 laptop:w-full half:w-full half:mx-2"
				>
					<span class="text-xl text-slate-700 font-medium mb-4 laptop:text-lg half:text-lg">Quick Docker Commands</span>
