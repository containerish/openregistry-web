    ...
    {#if isSetting}
      <div class="flex w-full justify-between items-center gap-9">
        ...
        >
          <div class="flex w-full justify-between items-center">
            <span class="text-lg font-semibold text-primary-400"
              >Scan for Vulnerabilities</span
            >
            <Switch />
          </div>
          <p class="text-sm text-slate-500 antialiased max-w-md">
            By turning this setting on, you will be able to scan any possible
        ...
        >
          <div class="flex w-full justify-between items-center">
            <span class="text-lg font-semibold text-primary-400"
              >Container Image Visibility</span
            >
            <Switch />
          </div>
          <p class="text-sm text-slate-500 antialiased max-w-md">
            The value of this feature determines the visibility of your
            container image. If the value is set to true/turned on, your image
