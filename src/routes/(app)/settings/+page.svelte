		...
		<div class="flex flex-col gap-9">
			...
			<Card>
				...
				>
					...
					>
						<h1
							class="text-lg lg:text-xl font-medium text-slate-600 mb-3"
						>
							Change Password
						</h1>
						<div class="w-full">
				...
				>
					<div class="flex flex-col gap-1">
						...
						<span class="text-slate-600 antialiased text-sm">
							This information is public and visible to all users
							of OpenRegistry
						</span>
					</div>
					<div
					...
					>
						<div class="flex flex-col gap-1">
							...
							<span class="text-slate-700 antialiased text-sm">
								...
								account your repositories will also deleted and
								will no longer be available to you or anyone
								else
							</span>
						</div>
						<div
