...
>
		...
		<div class="flex flex-col gap-9 text-slate-700" in:fly={{ y: 200, duration: 300 }}>
			...
			>
				<div class="flex flex-col gap-3">
					...
					<span class="text-sm">invite people to share the build project and collabotare with </span>
				</div>
			...
			>
				<div class="flex flex-col gap-3 md:w-2/3">
					...
					<span class="text-sm"
						>Deleting this project will permanently delete the project from openregistry and our databases
						and you will not be able to recover it. Along with it will go the environment variables and
						Access Policies
					</span>
				</div>
		...
		<div class="flex flex-col gap-9">
			<div class="flex flex-col gap-4">
				<div class="flex flex-col">
					...
					<span class="text-sm">specify the brach that triggers the build for each environment</span>
				</div>
				<div
				...
				>
					<div class="flex flex-col gap-6 items-start col-span-2 md:col-span-1">
						<div class="rounded-full bg-emerald-100 text-emerald-900 text-xs px-2 py-0.5"> Production </div>
			...
			bg-slate-50"
				...
				>
					<div class="flex flex-col gap-6 items-start col-span-2 md:col-span-1">
						<div class="rounded-full bg-slate-200 text-slate-800 text-xs px-2 py-0.5"> Preview </div>
			...
			<div class="flex flex-col gap-4">
				...
				<div
					...
					in:fly={{ y: 200, duration: 300, delay: 150 }}
				>
					<span class="text-sm">Add a deploy hook by creating a name and selecting a desired branch</span>
	...
	<div use:melt={$content('tab-3')} class="grow bg-white p-5">
		...
		<div class="flex flex-col gap-6">
			...
			<div class="border-2 border-slate-300 rounded" in:fly={{ y: 100, duration: 300, delay: 100 }}>
				<div class="bg-slate-200 grid grid-cols-3 py-2 px-3">
					<span class="col-span-1 font-semibold">Variable name</span>
					<span class="col-span-2 font-semibold">Value</span>
				</div>
