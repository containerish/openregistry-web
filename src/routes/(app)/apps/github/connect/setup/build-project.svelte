...
<div class="">
	...
	<div
		class="flex flex-col gap-3 mt-9"
	>
		<div class="flex">
	...
	<div class="border-primary-100 border mt-10 py-4 px-5 shadow-2xl">
		...
		<table class="table-auto">
			<tbody>
				<tr>
					<td
						class="text-base font-jetbrains-mono text-slate-600"
						>hello world!</td
					>
				</tr>
				<tr>
	...
	<span class="text-lg font-semibold text-primary-600 ml-2">
		Building and deployment settings</span>
	<div class="rounded-sm border shadow-inner bg-slate-50 mt-9 px-5 py-9 
	flex flex-col gap-3"
	>
		<div class="flex gap-6">
			...
			<div class="flex items-center gap-2">
				...
				<span
					class="text-slate-700 capitalize text-base"
		...
		<div class="flex gap-6">
			<span
				class="text-base text-slate-700 font-semibold"
				>Branch:
			</span>
		...
		<div class="flex gap-6">
			<span
				class="text-base font-semibold text-brown-900"
				>Duration:
			</span>
		</div>
		...
		<div class=" flex pt-9">
			...
			<span class="text-base antialiased">
				Build Settings</span
			>
		</div>
	</div>
