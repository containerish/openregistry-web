<script lang="ts">
  ...
  const repoOptions: SelectOptions = {
  ...
  const buildOptions: SelectOptions = {
...
<div class="w-full flex flex-col gap-6">
  <div class="flex flex-col justify-center items-center gap-2">
    ...
    <div class="flex flex-col lg:flex-row justify-center items-center gap-3">
      ...
      <div class="flex gap-1 items-center">
        ...
        >
          <u>
            {$ghStore.githubUsername}/{$ghStore.selectedRepository?.repository
              .name}
          </u>
        </a>
      </div>
  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="max-w-min">
      <Select
        ...
        title="Branch"
        options={repoOptions}
        placeholder={repoOptions.filterBy[0].value}
      />
    </div>
    <span class="text-xs lg:text-sm text-slate-700 antialiased">
  ...
  <div class="flex flex-col gap-1">
    ...
    <span class="text-xs lg:text-sm text-slate-700 antialiased">
      If your project uses a different tool than Docker (like nerdctl), then
      please set the build instructions for OpenRegistry
    </span>
    <div class="flex flex-col gap-6">
      <div class="flex flex-col my-6 gap-1 text-sm">
        <div class="max-w-min">
          <Select selectedItem={selectedBuildTool} title="" options={buildOptions} placeholder="Docker" />
        </div>
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="w-full max-w-[420px]">
          <Textfield type="search" value={selectedBuildToool.buildCommand} />
        </div>
