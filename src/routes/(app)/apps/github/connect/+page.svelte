<script lang="ts">
	...
	const installGithubApp = () => {
		const installationUrl =
			env.PUBLIC_GITHUB_APP_PUBLIC_LINK + "/installations/new";
...
<div
	class="flex flex-col items-center w-full min-w-min my-20"
		...
		<div class="w-full max-w-xl lg:max-w-4xl">
			<div class="flex flex-col justify-center items-center gap-3">
				...
				<span class="text-center text-sm text-slate-700 antialiased"
					>With three simple steps, you can set up automated builds
					with OpenRegistry.
					<br /> With every consequtive trigger (push/commit), OpenRegistry
					will bundle a build for you.
				</span>
			</div>
			<hr class="mx-0 my-10 lg:mx-10" />
			<div
				class="flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-10"
			>
				<!-- svelte-ignore a11y-img-redundant-alt -->
				<div in:fly={{ x: -100, duration: 400, delay: 300 }}>
					<img
						src="/catainer/catainer-hi.png"
				...
				<div class="flex flex-col items-center lg:items-start gap-6">
					<span
						class="text-slate-700 text-center lg:text-start antialiased max-w-lg"
						>Hi, I'm Catainer! <br /> I will help you with your
						first ever build. <br />
						To deploy a site, first select it from your personal or team
						GitHub account
					</span>
					<ButtonSolid
						class="max-w-[208px]"
