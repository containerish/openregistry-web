    ...
    <div class="flex flex-col min-h-[75vh] bg-cream-50 items-center space-y-6 p-10 pb-52 pt-32">
        <div class="min-w-max bg-white p-20 rounded-md w-3/4">
            ...
            <div class="flex flex-col items-start space-y-8 pl-24">
                <span class="text-left text-lg"><b>1. Select repository</b> <br/> 
                    Select your site developed using any of the supported frameworks or no framework at all.
                </span>
                <span class="text-left text-lg"><b>2. Set up builds and deployments</b><br/>
                    Specify how OpenRegistry automatically builds and deploys your 
                    repository's commits.
                </span>
                <span class="text-left text-lg"><b>3. Deploy site</b><br/>
                    <span>
                        Your site will be deployed to a free SSL-enabled hostname. Configure
                     custom domains, restrict access,<br/> invite collaborators, and more.
                    </span>
                </span>
