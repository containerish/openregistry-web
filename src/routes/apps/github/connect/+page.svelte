<script>
    ...
    <div class="flex flex-col min-h-[75vh] bg-cream-50 items-center space-y-6 p-10 pb-52 pt-32">
        ...
        <div class="min-w-max bg-white p-20 rounded-md w-3/4" transition:fade="{{delay: 300, duration: 300}}">
            ...
            <div class="flex flex-col space-y-9">
                <span class="text-lg">To deploy a site, first select it from your personal or team <br/>GitHub account.</span>
                <button
            ...
            <div class="flex flex-col justify-center items-center space-y-8">
                <span class="text-left w-96 text-lg"><b>1. Select repository</b> <br/> 
                    Select your site developed using any of the supported frameworks or no framework at all.
                </span>
                <span class="text-left w-96 text-lg"><b>2. Set up builds and deployments</b><br/>
                    Specify how OpenRegistry automatically builds and deploys your <br/>
                    repository's commits.
                </span>
                <span class="text-left w-96 text-lg"><b>3. Deploy site</b><br/>
                    <span>
