...
<div class="flex flex-col bg-cream-50 items-center space-y-6 px-10 pb-52 pt-20 min-h-[77vh]">
	<div class="flex static space-x-2 mx-4 mb-10">
		<div class="rounded-full bg-white w-6 shadow-lg flex justify-center">1</div>
		...
		<div class="w-12 border-t-2 border-brown-500 mt-2" />
		<div class="rounded-full bg-brown-800 w-6 text-white shadow-lg flex justify-center">3</div>
            ...
            <ModalNew>
                <div class="min-h-max px-5 flex flex-col space-y-5 py-8 mx-4">
                    <div class="flex">
                        ...
                        class="bg-transparent border-none text-sm inline-flex">
                            <Cross styles="w-8 h-8 text-brown-800"/>
                        </button>
                    </div>
                    <span class="text-lg">Your deployment will continue but if it 
                        fails, your site will not be available for visitors.</span>
                    <span class= "text-lg">
                        To initiate another deployment, <b>Retry deployment</b> or push a commit to your Production branch
                        <b>main.</b>
                    </span>
                </div>
