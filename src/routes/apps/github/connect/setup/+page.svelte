<script>
    ...
    <div class="flex flex-col min-h-[75vh] bg-cream-50 items-center space-y-6 px-10 pb-52 pt-20">
        <div class="flex static space-x-2 mx-4 mb-10">
            ...
            <div class="rounded-full bg-brown-600 w-6 text-white shadow-lg flex justify-center cursor-pointer">2</div>
        ...
        <div class="min-h-max bg-white p-20 rounded-md shadow-lg w-3/4" transition:fade="{{delay: 300, duration: 300}}">
            <div class="flex flex-col justify-center items-center space-x-5 space-y-5">
                ...
                <div class="flex space-x-3 justify-center items-center">
                    ...
                    <span class="">guacamole/blog</span>
                    <!-- must replace this with a variable -->
                </div> 
            </div>
            ...
            <div class="flex flex-col my-10 space-y-2">
                ...
                <span class="text-md"> Pushes to this branch automatically trigger deployments to the Production environment. Pushes to all other </span>
