...
<Card class=" bg-slate-50/50 mx-auto">
	<div class="w-full min-h-[90vh] mx-10 my-4 lg:my-20 max-w-[3000px]">
		...
		>
			<h1 class="text-2xl font-semibold text-slate-700 mb-5"> How do I rename a OpenRegistry repository? </h1>
			<span class="text-base text-slate-600">
				Currently, you cannot rename an OpenRegistry repository once it's been created. You will need to create
				a new repository with the name of your choice, move all relevant tags to the new repository created, and
				delete the existing repository you wish to rename.
			</span>
		</div>
		...
		>
			...
			<span class="text-base text-slate-600">
				Repositories can not be transferred to a different account. If you would like to transfer a repository
				to a different account, you will need to download any images You can then recreate the repository on the
				new account.
			</span>
		</div>
		...
		>
			...
			<span class="text-base text-slate-600">
				You can use a PAT (Personal Access Token) from GitHub for Docker CLI login. To create a PAT, follow the
				official GitHub guide here:
				<a
					href="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token"
				>
					GitHub Doc for PAT
				</a>
				and use the generated Personal Access Token as your password for docker login. <br /> The username will same
		...
		>
			...
			<span class="text-base text-slate-600">
				Currently, this functionality is unavailable. However, we're working on integrating it into OpenRegistry
		...
		<div
			...
			border-primary-100"
		>
			<h1 class="text-2xl font-semibold text-slate-700 mb-5"> How can I change my OpenRegistry Password </h1>
			<span class="text-base text-slate-600">
				To change your OpenRegistry Password, go to your
				<span class="text-primary-400 font-semibold">Profile -> Settings -> Change Password.</span><br />
				Enter the current password, new password and finally confirm the new password and there you have it! In case
				you forgot your OpenRegistry Password, please click on forgot password and you'll receive an email to reset
				the password
			</span>
		</div>
		...
		>
			...
			<span class="text-base text-slate-600">
				...
				please make sure to drop any bug reports or improvement advice in the section below. We'd love to hear
				from you!
			</span>
		</div>
		<div
		...
		>
			...
			<span class="text-base text-slate-600">
				If you are completely new to Containers and Container Registries and interested in learning more about
				it. You can follow our
				<a href="https://docs.openregistry.dev/" class="text-primary-400">documentation</a> where we cover
				everything from basics of containers, step to step guide to getting started and video content for more
				clarity. We also have cute little <b class="text-primary-400">zines</b> in place to make your learning experience
				more fun!
			</span>
		</div>
