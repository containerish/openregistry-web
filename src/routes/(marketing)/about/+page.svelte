...
<div class="flex flex-col xl:flex-row bg-primary-50/30 justify-center items-center">
	...
	<div class="flex flex-col w-full justify-start items-center my-2 lg:my-9 max-w-[1600px] mx-auto z-20 relative">
		<div
		...
		>
			<div class="max-w-5xl">
				<h1 class="text-4xl font-semibold text-primary-600"> Decentralisation is the Future! </h1>
				<h1 class="text-4xl font-semibold text-primary-600 mb-8">
					and we want to play a role in making it better
				</h1>
				<span class="text-base text-slate-800">
					Our Vision is derived and powered by the principals of Web 3.0 and Dworld of Dapps. With increasing
					awareness and adaption of distributed network, the worlds are moving towards a better future for
					everyone. OpenRegistry is an effort to bring a change with community's own container registry which
					is Open and Free to use. A true decentralised entity with promise of scalability, reliability and
					transparency.
				</span>
			</div>
			<div class="max-w-5xl">
				<span class="text-base text-slate-800">
					We started off as a fun project which eventually opened many doors for us. Although we are a small
					team, we are Passionate about what we do. We have learned, built and evolved our careers with help
					of OpenSource projects. With OpenRegistry, we want to built yet another project for public good.
				</span>
			</div>

			<span class="text-3xl font-semibold text-primary-600 mt-14"> Get to know our Team </span>
					...
					<div class="flex flex-col gap-4 px-4 lg:px-12 py-8 bg-white/90 rounded-sm shadow-3xl">
						...
						<div class="flex justify-center">
							...
							<a
								...
								target="_blank"
							>
								<GithubIcon class="h-6 w-6 lg:h-12 lg:w-12" />
							</a>
						</div>
					</div>
				</div>
				...
				<div class="flex flex-col-reverse lg:flex-row justify-center items-center">
					<div class="flex flex-col gap-4 px-4 lg:px-12 py-8 bg-white/90 rounded-sm shadow-3xl">
						...
						<p class=" text-slate-700 text-sm lg:text-base text-center">
							Incharge of developer experience at OpenRegistry. Works mostly on UI/UX and <br />frontend
							development. Loves illustrating, animating and designing merchandise
						</p>
