...
{#if user && user.UserPayload}
    <div class="min-h-[93vh] bg-cream-50">
        <div class="flex gap-5 space-x-10 min-w-full justify-start items-center py-28 my-20 px-20 bg-brown-500">
            <div class="px-4"></div>
            <div>
        ...
        <Card>
            <div class="rounded-xl flex flex-col w-3/4 flex bg-brown-400 px-20 py-8">
                ...
                <div>
                    ...
                    disabled placeholder={user.UserPayload.email}>
            ...
            <div class="rounded-xl flex flex-col w-3/4 flex bg-brown-400 px-20 py-8 mt-5">
                ...
                <div class="flex flex-col">
                    <input type="password" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                     ...
                     focus:ring-opacity-40" placeholder="current password">
                    ...
                    <input type="password" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                     sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                     focus:ring-opacity-40" placeholder="confirm password">
        ...
        <Card>
            <div class="rounded-xl flex flex-col w-3/4 flex bg-brown-400 px-20 py-8 mt-5 mb-20">
                ...
                <div class="flex flex-col">
                    ...
                    sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                    focus:ring-opacity-40" placeholder="Full Name">

                    <input type="text" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                    sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                    focus:ring-opacity-40" placeholder="Company">

                    <input type="text" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                    sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                    focus:ring-opacity-40" placeholder="Location">

                    <input type="text" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                    sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                    focus:ring-opacity-40" placeholder="Profile Url">

                    <input type="text" class="w-1/2 mt-5 px-4 py-3 -ml-1.5 text-md text-gray-700 bg-white border rounded-md
                    sm:mr-5 focus:border-brown-800 focus:outline-none focus:ring focus:ring-brown-700
                    focus:ring-opacity-40" placeholder="Github">
